...
Steps.fillStepOutput  = function(id, data, responseTime) {
  $(id).html(`Output: ${data}. Response time: ${responseTime} milliseconds`).slideDown();
}
...
ParseRequest.postData = function() {
  ...
  var responseTime; // responseTime variable
  XHR.setCallback(function(data){
    ...
    Steps.fillStepOutput('#step-1-output', data, responseTime.toFixed(2));
...
ParseRequest.getData = function() {
  ...
  XHR.setCallback(function(data){
    ...
    Steps.fillStepOutput('#step-2-output', data, responseTime.toFixed(2));
...
ParseRequest.postCloudCodeData = function() {
  ...
  XHR.setCallback(function(data){
    ...
    Steps.fillStepOutput('#step-3-output', data, responseTime.toFixed(2));
